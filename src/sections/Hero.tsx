  ...
  return (
    <section className="relative min-h-[90vh] flex items-center pt-32 sm:pt-40 pb-20 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden bg-black">
        <iframe
          src="https://www.youtube.com/embed/phwymplGT5Q?autoplay=1&mute=1&loop=1&playlist=phwymplGT5Q&controls=0&rel=0&iv_load_policy=3&modestbranding=1&playsinline=1&vq=hd2160&start=10&end=155&disablekb=1"
          allow="autoplay; encrypted-media"
          className="absolute top-1/2 left-1/2 min-w-full min-h-full -translate-x-1/2 -translate-y-1/2 pointer-events-none scale-[1.3]"
